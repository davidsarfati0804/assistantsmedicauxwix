...
export default function VideoSection() {
  return (
    <section className="bg-[#e8f0fe] py-[60px] mt-[72px]">
      <div className="max-w-[1140px] mx-auto px-6">
        <div className="grid grid-cols-[55%_1fr] gap-12 items-center max-md:grid-cols-1">
          <div>
            <a href="https://www.youtube.com/watch?v=P8M6xS8TEBE" target="_blank" rel="noopener" className="relative block cursor-pointer rounded-md overflow-hidden">
            ...
            <p className="text-[11px] text-center mt-1.5">Source Assurance Maladie</p>
          </div>
          <div>
