  ...
  return (
    <>
      ...
      <main className="pt-[68px]">
        ...
        />
        <ResumeBanner>
          Le dispositif assistant médical CPAM permet aux médecins libéraux (secteur 1, 2 OPTAM, secteur 3) de recevoir une aide financière de 19 000 à 38 000 €/an pour employer un assistant médical. Instauré par la Convention Médicale 2024–2029, ce contrat de 5 ans est renouvelable. Mesdocs Groupement d'Employeurs accompagne les médecins dans toutes les démarches CPAM, sans que le médecin ait à gérer les obligations d'employeur.
        </ResumeBanner>
